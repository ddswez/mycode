...
import com.ddswez.lpf.myapplication.hack.hack7.DrawView;

/*******************************************************************************
 * Copyright (c) 2012 Manning
 * See the file license.txt for copying permission.
 * 代码来源:
 * https://github.com/Macarse/50AH-code/blob/master/hack007/src/com/manning/androidhacks/hack007/MainActivity.java
 ******************************************************************************/
...
public class Rectangle extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        mDrawRect.set(mCoordX, mCoordY, mCoordX + mRealSize, mCoordY
                + mRealSize);
        /**
         * 参考: http://book.51cto.com/art/201204/328247.htm
         */
