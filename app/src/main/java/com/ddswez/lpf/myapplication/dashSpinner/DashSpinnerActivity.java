package com.ddswez.lpf.myapplication.dashSpinner;
...
public class DashSpinnerActivity extends AppCompatActivity implements DashSpinner.OnDownloadIntimationListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dash_spinner);
